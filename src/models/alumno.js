    ...
    id_carrera:{
        ...
        validate: {
            async isValid(value) {
                ...
                let carrera = await sequelize.models.Carrera.findOne({where: {id_carrera: value}})
                if(!carrera)
                    throw new Error('No es una carrera válida.')
            }
        }
    }
},{
...
sequelize.sync() //SINCRONIZAR BASE DE DATOS
